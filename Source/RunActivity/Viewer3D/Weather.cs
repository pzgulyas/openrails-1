...
namespace Orts.Viewer3D
{
    public class WeatherControl
    {
        ...
        public virtual void Update(ElapsedTime elapsedTime)
        {
            ...
            // If we're a multiplayer server, send out the new overcastFactor, pricipitationIntensity and VisibilityM to all clients.
