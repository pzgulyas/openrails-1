...
namespace ORTS.Settings
{
    ...
    public class InputSettings : SettingsBase
    {
        ...
        static extern int GetKeyNameText(int scanCode, [MarshalAs(UnmanagedType.LPWStr), Out] StringBuilder name, int nameLength);
        #endregion
        ...
        public static string GetScanCodeKeyName(int scanCode)
        {
            ...
            var keyNameLength = GetKeyNameText(scanCode << 16, sb, sb.Capacity);
